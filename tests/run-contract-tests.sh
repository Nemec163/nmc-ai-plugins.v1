...
CONTRACT_FIXTURE_TEST="$REPO_ROOT/packages/memory-contracts/test/validate-fixtures.js"
INGEST_FIXTURE_TEST="$REPO_ROOT/packages/memory-ingest/test/validate-fixtures.js"
CANON_FIXTURE_TEST="$REPO_ROOT/packages/memory-canon/test/validate-fixtures.js"
MAINTAINER_FIXTURE_TEST="$REPO_ROOT/packages/memory-maintainer/test/validate-fixtures.js"
SCRIPTS_FIXTURE_TEST="$REPO_ROOT/packages/memory-scripts/test/validate-fixtures.js"
WORKSPACE_FIXTURE_TEST="$REPO_ROOT/packages/memory-workspace/test/validate-fixtures.js"
AGENTS_FIXTURE_TEST="$REPO_ROOT/packages/memory-agents/test/validate-fixtures.js"
PIPELINE_FIXTURE_TEST="$REPO_ROOT/packages/memory-pipeline/test/validate-fixtures.js"
GATEWAY_FIXTURE_TEST="$REPO_ROOT/packages/memory-os-gateway/test/validate-fixtures.js"
CONTROL_PLANE_FIXTURE_TEST="$REPO_ROOT/packages/control-plane/test/validate-fixtures.js"
ADAPTER_CONFORMANCE_FIXTURE_TEST="$REPO_ROOT/packages/adapter-conformance/test/validate-fixtures.js"
ADAPTER_OPENCLAW_FIXTURE_TEST="$REPO_ROOT/packages/adapter-openclaw/test/validate-fixtures.js"
ADAPTER_CODEX_FIXTURE_TEST="$REPO_ROOT/packages/adapter-codex/test/validate-fixtures.js"
...
test_shared_agents_package_fixture_validation() {
  print_case "TEST" "@nmc/memory-agents validates predefined role bundles and render output"

  if ! require_file "$AGENTS_FIXTURE_TEST" "shared agents package fixture test"; then
    return
  fi
  ...
  if grep -q "@nmc/memory-agents" "$LAST_STDOUT"; then
    pass "shared agents fixture validation"
  else
    fail "shared agents fixture validation" "Fixture validation output did not confirm agents package execution"
  fi
}
